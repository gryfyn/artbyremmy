    ...
    <>
      ...
      >
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-0 right-1/3 w-32 h-32 bg-gradient-to-bl from-[#3A4D37]/8 via-[#3A4D37]/5 to-[#3A4D37]/6 rounded-full blur-xl animate-pulse" style={{animationDelay: '1s'}}></div>
        </div>
        ...
        <div className="relative max-w-6xl mx-auto flex justify-between items-center px-6">
          <div className="group cursor-pointer">
            <div className="relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-r from-[#3A4D37]/15 via-[#3A4D37]/15 to-[#3A4D37]/15 blur-xl opacity-0 group-hover:opacity-100 transition-all duration-700 transform group-hover:scale-110 rounded-lg"></div>
          ...
          >
            ...
            <div className="relative z-10 w-6 h-6 flex items-center justify-center">
              <div className={`transition-all duration-400 ${isMobileMenuOpen ? 'rotate-180' : 'rotate-0'}`}>
                {isMobileMenuOpen ? (
      ...
      >
        <div className={`bg-[#F1E9DC]/98 backdrop-blur-lg shadow-lg border-b border-[#3A4D37]/20 ${
            ...
            <div className="flex items-center justify-center space-x-6">
              {navigationItems.map((item, index) => {
                ...
                return (
                  ...
                  >
                    <div className={`absolute inset-0 bg-gradient-to-br ${item.color} rounded-lg scale-0 group-hover:scale-105 transition-all duration-500 opacity-20`}></div>
                    <div className={`absolute inset-0 bg-gradient-to-br ${item.color} rounded-lg scale-0 group-hover:scale-110 transition-all duration-700 opacity-10 blur-lg`}></div>
                    
                    <div className="relative z-10 flex items-center justify-center">
                      <div className="relative">
                        <div className={`absolute inset-0 bg-gradient-to-br ${item.color} rounded-full scale-0 group-hover:scale-125 transition-all duration-600 blur-md opacity-40`}></div>
                    ...
                    <div className={`absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 group-hover:w-6 h-0.5 bg-gradient-to-r ${item.color} transition-all duration-500 rounded-full`}></div>
                  </a>
                );
              })}
            </div>
            ...
            <div className="mt-4 flex items-center justify-center">
              <div className="flex items-center space-x-3">
                ...
                <div className="flex space-x-1">
                  ...
                  <div className="w-0.5 h-0.5 bg-gradient-to-br from-[#3A4D37]/60 to-[#3A4D37] rounded-full animate-pulse" style={{animationDelay: '0.5s'}}></div>
                  <div className="w-0.5 h-0.5 bg-gradient-to-br from-[#3A4D37] to-[#3A4D37]/60 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
                </div>
                <div className="w-10 h-px bg-gradient-to-r from-transparent via-[#3A4D37]/30 to-transparent"></div>
              </div>
            </div>
