      ...
      <main className="flex-1 relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-16 mt-16 sm:mt-20">
        ...
        <section className="text-center mb-8 sm:mb-12 md:mb-16 relative">
          ...
          <div className="relative z-10">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-3 sm:mb-4 bg-gradient-to-r from-[#3A4D37] via-emerald-600 to-[#3A4D37] bg-clip-text text-transparent px-4">
              Commission Your
              <span className="block text-2xl sm:text-3xl md:text-4xl lg:text-5xl mt-2">Dream Artwork</span>
            </h1>
            
            {/* Artistic Divider */}
            <div className="flex items-center justify-center space-x-2 sm:space-x-4 my-6 sm:my-8 px-4">
              <div className="w-8 sm:w-16 h-px bg-gradient-to-r from-transparent to-[#3A4D37]/40"></div>
              <Palette className="w-6 sm:w-8 h-6 sm:h-8 text-emerald-600 flex-shrink-0" />
              <div className="w-12 sm:w-24 h-px bg-gradient-to-r from-emerald-600 to-teal-600"></div>
              <Sparkles className="w-5 sm:w-6 h-5 sm:h-6 text-teal-600 flex-shrink-0" />
              <div className="w-12 sm:w-24 h-px bg-gradient-to-r from-teal-600 to-emerald-600"></div>
              <Brush className="w-6 sm:w-8 h-6 sm:h-8 text-emerald-600 flex-shrink-0" />
              <div className="w-8 sm:w-16 h-px bg-gradient-to-r from-[#3A4D37]/40 to-transparent"></div>
            </div>
            
            <p className="text-sm sm:text-base md:text-lg text-[#3A4D37]/70 max-w-3xl mx-auto leading-relaxed px-4">
              ...
              <div className="relative bg-white/95 backdrop-blur-xl rounded-xl sm:rounded-2xl shadow-2xl border border-[#3A4D37]/20 p-4 sm:p-6 md:p-8">
                ...
                <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
                  <div className="group">
                    ...
                    <input
                      ...
                      className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 border-2 rounded-xl bg-white/80 text-[#3A4D37] placeholder-[#3A4D37]/50 transition-all duration-300 text-sm sm:text-base ${
                        focusedInput === "name"
                ...
                <div className="mb-4 sm:mb-6 group">
                  ...
                  <input
                    ...
                    className="w-full px-3 sm:px-4 py-2.5 sm:py-3 border-2 border-[#3A4D37]/20 rounded-xl bg-white/80 text-[#3A4D37] placeholder-[#3A4D37]/50 focus:outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/20 transition-all duration-300 text-sm sm:text-base"
                    required
                  />
                </div>
                ...
                <div className="mb-6 sm:mb-8 group">
                  ...
                  <textarea
                    ...
                    className="w-full px-3 sm:px-4 py-2.5 sm:py-3 border-2 border-[#3A4D37]/20 rounded-xl bg-white/80 text-[#3A4D37] placeholder-[#3A4D37]/50 focus:outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/20 transition-all duration-300 resize-none text-sm sm:text-base"
                  />
                </div>
                ...
                <button
                  ...
                  className="group relative w-full py-3 sm:py-4 font-semibold text-white rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 disabled:opacity-50 transition-all duration-300 transform hover:scale-105 hover:shadow-xl overflow-hidden text-sm sm:text-base"
                >
        ...
        <section className="mb-12 sm:mb-16">
          <div className="text-center mb-8 sm:mb-12 px-4">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4 bg-gradient-to-r from-[#3A4D37] via-emerald-600 to-[#3A4D37] bg-clip-text text-transparent">
              Why Choose Our Art?
            </h2>
            <p className="text-sm sm:text-base md:text-lg text-[#3A4D37]/70 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
            {features.map((feature, i) => (
              <div
                key={i}
                className="group relative bg-white/90 backdrop-blur-xl rounded-xl sm:rounded-2xl shadow-xl border border-[#3A4D37]/20 p-4 sm:p-6 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500"
              >
                <div className={`absolute inset-0 bg-gradient-to-br ${feature.gradient} opacity-0 group-hover:opacity-10 transition-all duration-300 rounded-xl sm:rounded-2xl`}></div>
                
                <div className="relative z-10 text-center">
                  <div className={`mx-auto mb-3 sm:mb-4 w-12 h-12 sm:w-16 sm:h-16 flex items-center justify-center rounded-xl sm:rounded-2xl bg-gradient-to-br ${feature.gradient} text-white shadow-lg`}>
                    {feature.icon}
                  </div>
                  <h3 className="font-bold text-[#3A4D37] mb-1.5 sm:mb-2 text-sm sm:text-base">{feature.title}</h3>
                  <p className="text-xs sm:text-sm text-[#3A4D37]/70">{feature.description}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {reviews.map((review, i) => (
              <div
                key={i}
                className="group relative bg-white/95 backdrop-blur-xl rounded-xl sm:rounded-2xl shadow-xl border border-[#3A4D37]/20 p-4 sm:p-6 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500"
              >
                <div className={`absolute inset-0 bg-gradient-to-br ${review.gradient} opacity-0 group-hover:opacity-10 transition-all duration-300 rounded-xl sm:rounded-2xl`}></div>
                
                <div className="relative z-10">
                  <div className="flex items-center mb-3 sm:mb-4">
                    <div className={`w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-full bg-gradient-to-br ${review.gradient} text-white text-base sm:text-lg mr-3 sm:mr-4 shadow-lg flex-shrink-0`}>
                      {review.avatar}
                    </div>
                    <div className="min-w-0">
                      <h4 className="font-bold text-[#3A4D37] text-sm sm:text-base truncate">{review.name}</h4>
                      <div className="flex gap-1">
                        {[...Array(review.rating)].map((_, idx) => (
                          <Star key={idx} className="w-3 h-3 sm:w-4 sm:h-4 text-yellow-500 fill-yellow-500" />
                        ))}
                      </div>
                    </div>
                  </div>
                  
                  <p className="text-xs sm:text-sm text-[#3A4D37]/80 italic mb-3 sm:mb-4 leading-relaxed">
                    {review.comment}
                  </p>
                  
                  <div className="flex items-center justify-between flex-wrap gap-2">
                    <span className="text-xs font-bold text-emerald-600 uppercase tracking-wide bg-emerald-100 px-2 sm:px-3 py-1 rounded-full whitespace-nowrap">
                      {review.artType} Art
                    </span>
